...
<div class="search-container text-center my-4">
    <form method="GET" action="search.php" class="search-bar d-inline-flex">
        <input type="text" name="query" class="form-control me-2 search-input" placeholder="Tìm món ăn..." required>
